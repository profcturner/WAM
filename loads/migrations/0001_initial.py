    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(to='loads.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(to='loads.Task')),
            ],
        ),
        migrations.AddField(
            model_name='activitytype',
            name='category',
            field=models.ForeignKey(to='loads.Category'),
        ),
        migrations.AddField(
            model_name='activity',
            name='activity_type',
        ...
        migrations.AddField(
            model_name='activity',
            name='module',
            field=models.ForeignKey(null=True, to='loads.Module'),
        ),
        migrations.AddField(
            model_name='activity',
            name='staff',
            field=models.ForeignKey(null=True, to='loads.Staff'),
        ),
    ]

...
urlpatterns = [
    ...
    url(r'^external/$', views.external_index, name='external_index'),
    url(r'^external/modules/index/(?P<semesters>[0-9,]*)$', views.external_modules_index, name='external_modules_index'),

...
urlpatterns = [
    ...
    re_path(r'^external/modules/index/(?P<semesters>[0-9,]*)$', views.external_modules_index, name='external_modules_index'),
    re_path(r'^generators/index/$', views.generators_index, name='generators_index'),
    re_path(r'^generators/generate_activities/(?P<generator_id>[0-9]+)$', views.generators_generate_activities, name='generators_generate_activities'),
    re_path(r'^tasks/index/$', views.tasks_index, name='tasks_index'),
    re_path(r'^tasks/archived/index/$', views.archived_tasks_index, name='archived_tasks_index'),
    re_path(r'^tasks/create/$', CreateTaskView.as_view(), name='create task'),
    re_path(r'^tasks/update/(?P<pk>[0-9]+)$', UpdateTaskView.as_view(), name='update task'),
    re_path(r'^tasks/completion/(?P<task_id>[0-9]+)/(?P<staff_id>[0-9]+)$', views.tasks_completion, name='tasks_completion'),    
    ...
    re_path(r'^modules/add_assessment_resource/(?P<module_id>[0-9]+)$', views.add_assessment_resource, name='add_assessment_resource'),
    re_path(r'^modules/download_assessment_resource/(?P<resource_id>[0-9]+)$', views.download_assessment_resource, name='download_assessment_resource'),
    re_path(r'^modules/delete_assessment_resource/(?P<resource_id>[0-9]+)(?P<confirm>/confirm)?$', views.delete_assessment_resource,
    ...
    re_path(r'^modules/allocations/(?P<package_id>[0-9]+)/(?P<module_id>[0-9]+)$', views.module_staff_allocation, name='module_staff_allocation'),
    ...
    re_path(r'^projects/generate_activities/(?P<project_id>[0-9]+)$', views.projects_generate_activities, name='projects_generate_activities'),
    re_path(r'^staff/allocation/(?P<package_id>[0-9]+)/(?P<staff_id>[0-9]+)$', views.staff_module_allocation, name='staff_module_allocation'),    
